    ...
    <div class="sb-sidenav-menu-heading">
        ...
        <div class="sb-sidenav-menu-heading-v2">
            <ul>
                ...
                <li>
                    <a href="">
                        <svg style="" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bell" viewBox="0 0 16 16">
    ...
    <div class="sb-sidenav-menu">
        ...
        <div class="search-box">
            <div class="search-box-background" style="">
                    <div class="search-box-wrapper" style=";position: relative;width: 70%">
                        <svg style="padding-left: 20px;padding-top: 9px;" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
                            <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
                        </svg>
                        <input placeholder="search..." class="box-input" style="margin-left: 10px;width: 90%;font-size: 18px;height: 30px;border-style: none;padding: 0;outline: none;background: #c2c1c1" type="text" tabindex="0" >
                    </div>
                ...
                <div style="margin-left: 10px">
                    ...
                    <div class="search-by-address" style="width: 25%;">
                        ...
                        <select name="searchAddress" id="searchAddress" style="font-size: 18px;width: 100%;height: 30px;border-style: none;padding: 0;outline: none;background: #c2c1c1">
                    ...
                    <div class="icon-search">
                        ...
                        <button type="submit" style="background: #9999de;border-radius: 7px;border-style: none;height: 38px">
                        <svg style=";border-radius: 3px" xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
                            <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
                        </svg>
                        </button>
        ...
        <div style="margin-left: 20px;height: 44px">
            <button style="height: 44px;border-radius: 9px;width: 120px;border: solid 2px orange">
                ...
                <a href="https://wowcv.vietnamworks.com/?utm_source=Bar&utm_medium=Job_Search" style="text-decoration: none;font-size: 16px;color: black">
                    Mẫu CV
                </a>
            </button>
        </div>
        <div class="icon-avatar">
            <button style="text-align: center;height: 44px;border-radius: 9px;width: 200px;border: solid 2px orange;margin-left: 50px">

            <svg style="" xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
                ...
                <div class="swiper-wrapper" style=";margin-right: 10px;">
                    ...
                    <div class="content">
                        <div class="job-desc">
                            ...
                            <div>
                                <a href="">
                                    <button style="height: 30px;background: orange;border-radius: 5px">Apply Now</button>
                                </a>
                            </div>
                        </div>
                    </div>
